// TemperatÅ«rÅ³ matavimas suskirstytas ÄÆ tris lygius.
// pirmas lygis bus Å�ilumos generatoriai- Katilo iÅ�Ä—jimas, SaulÄ—s kolektorius
// ir PamaiÅ�ymo voÅ¾tuvas
// antras lygis bus Å�ilumos imtuvai- AkumuliacinÄ—s virÅ�aus ir Boilerio virÅ�aus davikliai
// treÄ¨ias lygis bus visi likÄ™ davikliai
// TemperatÅ«ra matuojama 3 skirtingais laiko intervalais:
