...
#define Key_Pin 31 //Analogines klaviaturos pajungimo i6vadas A3
volatile int klaviaturos_pasikeitimas =-1;               // Tikrinti ar pasikeitė klaviatūros reikšmė
volatile int x=-1;                 // 
volatile int stan_Analog;          // 
/* ********** LCD aprasymas ******************* */
#define BackLight_Pin 12 //LCD pasvietimo isvadas (standart LCD KeeyPad use pin 10)
...
/* ******************** reles *********************************** */
#define Relay12 0
#define B_termostatas 1 // boilerio termostatas
#define MV_K_21 2 // motorizuotas vožtuvas katiui, 2.1 Uždarymas
#define MV_K_11 3 // motorizuotas vožtuvas katiui, 1.1 Atidarymas
#define MV_A_21 29 // motorizuotas vožtuvas akumuliacinei 2.1 Uždarymas
#define MV_A_11 13 // motorizuotas vožtuvas akumuliacinei 1.1 Atidarymas
#define PVsiurblys 14 // PV siurblys
#define PVuzdarymas 15 // PV uždarymas Relė 5
#define PVatidarymas 16 // PV atidarymas Relė 4
#define BSiurblys 17 // B siurblio junginėjimui Relė 3
#define SKSiurblys 18 // SK siurblio junginėjimui Relė 2
#define ATSiurblys 19 // AT siurblio junginėjimui Relė 1

/* ************************** davikliai *********************** */
#define ONE_WIRE_BUS1 20
#define ONE_WIRE_BUS2 21
#define ONE_WIRE_BUS3 22
#define ONE_WIRE_BUS4 23
#define ONE_WIRE_BUS5 24
#define ONE_WIRE_BUS6 25
#define ONE_WIRE_BUS7 26
#define ONE_WIRE_BUS8 27
#define ONE_WIRE_BUS9 28
